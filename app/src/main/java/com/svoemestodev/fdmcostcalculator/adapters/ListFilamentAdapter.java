...
import com.svoemestodev.fdmcostcalculator.Filament;
import com.svoemestodev.fdmcostcalculator.R;

public class ListFilamentAdapter extends ArrayAdapter<Filament> {

    public ListFilamentAdapter(@NonNull Context context) {
        super(context, R.layout.select_item, Filament.loadList());
    }

    @NonNull
    @Override
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        final Filament item = getItem(position);
        if (convertView == null) {
