...
import com.svoemestodev.fdmcostcalculator.Plastic;
import com.svoemestodev.fdmcostcalculator.R;

public class ListPlasticAdapter extends ArrayAdapter<Plastic> {

    public ListPlasticAdapter(@NonNull Context context) {
        super(context, R.layout.select_item, Plastic.loadList());
    }

    @NonNull
    @Override
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        final Plastic item = getItem(position);
        if (convertView == null) {
